...
import { PLAYERS_BY_ID, TEAMS_BY_ID } from '../data/mockStatsMoney';
import '../comparePage.css';

type CompareMode = 'players' | 'teams';

const CompareMoneyPage: React.FC = () => {
  ...
  return (
    <div className="comparePageWrapper">
      <header className="compareHeader">
        ...
        <h1 className="compareTitle">Compare {mode === 'players' ? 'Players' : 'Teams'} (Money)</h1>
      </header>
          ...
          <div className="compareTableCard">
            ...
            {mode === 'players' ? (
              <>
                ...
                <div className="compareSectionTitle">Money</div>
                <div className="compareTableRow">
                  <div className="compareColItem">${PLAYERS_BY_ID[id1]?.money}M</div>
                  <div className="compareColLabel">Money</div>
                  <div className="compareColItem">${PLAYERS_BY_ID[id2]?.money}M</div>
                </div>
              ...
              <>
                ...
                <div className="compareTableRow">
                  <div className="compareColItem">${TEAMS_BY_ID[id1]?.money}M</div>
                  <div className="compareColLabel">Money</div>
                  <div className="compareColItem">${TEAMS_BY_ID[id2]?.money}M</div>
                </div>
...
export default CompareMoneyPage;