...
const teams: Team[] = [
  {
    name: "Lakers",
    players: [
      { name: "LeBron James", points: 28, rebounds: 7, assists: 8, fgPercent: 51, threePPercent: 34, ftPercent: 69, steals: 1, blocks: 1, turnovers: 3, salary: 45000000 },
      { name: "AD", points: 22, rebounds: 9, assists: 3, fgPercent: 49, threePPercent: 30, ftPercent: 74, steals: 0, blocks: 2, turnovers: 2, salary: 37000000 },
    ],
  },
  {
    name: "Warriors",
    players: [
      { name: "Stephen Curry", points: 30, rebounds: 5, assists: 6, fgPercent: 48, threePPercent: 42, ftPercent: 91, steals: 2, blocks: 0, turnovers: 3, salary: 43000000 },
      { name: "Klay Thompson", points: 22, rebounds: 4, assists: 3, fgPercent: 45, threePPercent: 38, ftPercent: 85, steals: 1, blocks: 1, turnovers: 2, salary: 37000000 },
    ],
  },
  {
    name: "Heat",
    players: [
      { name: "Jimmy Butler", points: 27, rebounds: 6, assists: 7, fgPercent: 50, threePPercent: 30, ftPercent: 83, steals: 1, blocks: 1, turnovers: 3, salary: 36000000 },
      { name: "Bam Adebayo", points: 20, rebounds: 9, assists: 5, fgPercent: 51, threePPercent: 25, ftPercent: 72, steals: 1, blocks: 2, turnovers: 2, salary: 32000000 },
    ],
  },
];
...
const ComparePage: React.FC = () => {
        ...
        <div className="roundedBox">
          <table>
            ...
            <tbody>
              ...
              <tr><td>Salary</td><td>${pA.salary.toLocaleString()}</td><td>${pB.salary.toLocaleString()}</td></tr>
            </tbody>
          </table>
        </div>
      );
        ...
        <div className="roundedBox">
          <table>
            ...
            <tbody>
              ...
              <tr><td>Efficiency</td><td>{((sA.points+sA.rebounds+sA.assists+sA.steals+sA.blocks-sA.turnovers)/tA.players.length).toFixed(1)}</td>
                  <td>{((sB.points+sB.rebounds+sB.assists+sB.steals+sB.blocks-sB.turnovers)/tB.players.length).toFixed(1)}</td></tr>
            </tbody>
          </table>
        </div>
      );
  ...
  return (
    <div>
      <h1 className="ProfileCSS">Basketball Compare</h1>
